      ...
      <section className="p-4 w-1/2 mx-auto bg-white shadow-[rgba(0,_0,_0,_0.35)_0px_4px_8px] rounded-lg">
        ...
        <form className="grid grid-cols-2 gap-6 ">
          ...
          <div className="col-span-2">
            ...
            <Textarea
              id="biografia"
              className="w-full min-h-20 max-h-28 border-[1.5px] border-zinc-400"
            />
          </div>

          <div>
            <label
              htmlFor="qual-seu-semestre"
              className="text-purple-600 font-medium text-sm"
            >
              Qual seu Semestre
            </label>
          ...
          <Button
            type="submit"
            className="w-full col-span-2 bg-purple-600 hover:bg-purple-700"
          >
            Salvar Alterações
          </Button>
        </form>
